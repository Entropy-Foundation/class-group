...
fn create_config() -> Result<Config> {
    let mut crate_properties = CrateProperties::new("bicycl", "0.1.0");
...
fn main() {
    ...
    config.set_all_crate_names(vec!["bicycl".into()]);
